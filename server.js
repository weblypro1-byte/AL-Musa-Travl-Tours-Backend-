...
const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width:600px; margin:auto; border:1px solid #eee; border-radius:10px; overflow:hidden;">
        ...
        <div style="padding:20px; color:#333;">
          ...
          <p><b>Message:</b></p>
          <blockquote style="background:rgba(18, 18, 18, 0.07); padding:10px; border-left:4px solidrgb(255, 104, 4);">
            ${message}
          </blockquote>
        </div>
  
        <!-- Footer -->
        <div style="background:#f1f1f1; padding:15px; text-align:center; font-size:14px; color:rgb(0, 0, 0);">
    ...
    attachments: [
        {
          filename: "logoo.png",                // the name shown in email
          path: __dirname + "/logoo.png",       // actual location in backend
          cid: "brandLogo",                     // must match src="cid:brandLogo"
        },
      ],
  };
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width:500px; margin:auto; border:1px solid #eee; border-radius:10px; overflow:hidden;">
            ...
            <div style="padding:20px; color:#333; text-align:center;">
              <h3>🎉 New Client</h3>
              <p>A new user has Sent a E-Mail.</p>
